...
export default function App2DClient() {
    ...
    return (
      <LayoutShell>
        <EmptyState
          ...
          description="2D DXF görüntüleyici için bir proje dosyası seçin."
  ...
  return (
    <LayoutShell>
      <div className="flex flex-col gap-sectionGap">
        <AppSwitcher />
        <ScxContextHeader fileName={context.scx} format="DXF" status="Hazır" />
        <div className="flex flex-col gap-cardGap rounded-r2 border-soft bg-surface px-cardPad py-cardPad">
          ...
          <div className="rounded-r2 border-soft bg-surface2 px-cardPad py-cardPad text-fs1 text-muted">
            DXF yerel görüntüleyici (yer tutucu)
          </div>
        </div>
      </div>
    </LayoutShell>
