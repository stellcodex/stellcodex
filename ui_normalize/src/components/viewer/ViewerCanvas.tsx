...
function ModelScene({
  ...
  React.useEffect(() => {
    scene.traverse((object) => {
      ...
      if (object instanceof Mesh && object.material) {
        ...
        material.color.copy(selectedNodeNames.has(object.name) ? new Color("#111111") : new Color("#cfcfcf"));
        material.emissive.copy(selectedNodeNames.has(object.name) ? new Color("#1f1f1f") : new Color("#000000"));
        material.emissiveIntensity = selectedNodeNames.has(object.name) ? 0.12 : 0;
  ...
  return (
    <>
      ...
      <gridHelper args={[200, 20, "#d6d6d6", "#ececec"]} />
    </>
  );
}
...
export function ViewerCanvas({
  ...
  if (viewer.file.kind !== "3d") {
    return (
      <div className="h-full min-h-[480px] overflow-hidden rounded-[12px] border border-[#eeeeee] bg-white">
        {viewer.contentUrl ? (
  ...
  return (
    <div className="h-full min-h-[560px] overflow-hidden rounded-[12px] border border-[#eeeeee] bg-white">
