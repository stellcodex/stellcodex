...
class Settings(BaseSettings):
    ...
    # Admin bootstrap
    bootstrap_admin_email: Optional[str] = Field(default=None, validation_alias="BOOTSTRAP_ADMIN_EMAIL")
    bootstrap_admin_token: Optional[str] = Field(default=None, validation_alias="BOOTSTRAP_ADMIN_TOKEN")
