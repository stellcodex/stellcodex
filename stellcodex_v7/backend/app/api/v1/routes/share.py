...
def _generate_share_token(min_length: int = MIN_SHARE_TOKEN_LENGTH) -> str:
    # token_urlsafe(48) yields ~64 chars; loop guarantees policy minimum.
...
def create_share_contract_alias(
