...
const NAV_ITEMS = [
  { href: "/", label: "Home", workspaceScoped: true },
  { href: "/apps", label: "Applications", workspaceScoped: true },
  { href: "/projects", label: "Projects", workspaceScoped: false },
  { href: "/files", label: "Files", workspaceScoped: false },
  { href: "/shares", label: "Shares", workspaceScoped: false },
  { href: "/settings", label: "Settings", workspaceScoped: false },
] as const;
      ...
      <aside className="layout-sidebar">
        ...
        <section className="sidebar-section">
          ...
          <div className="sidebar-list">
            {NAV_ITEMS.map((item) => {
              const href = item.workspaceScoped ? resolveWorkspaceHref(workspaceId, item.href) : item.href;
              return (
            ...
            {user.role === "admin" ? (
              <Link className="sidebar-link" data-active={isActive("/admin")} href="/admin">
                {collapsed ? "A" : "Admin"}
              </Link>
            ) : null}
          </div>
