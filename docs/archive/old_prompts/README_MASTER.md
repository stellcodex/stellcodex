...
- Reason retired: This mixed-language UI authority and operator prompt has been superseded by the GitHub canonical V10 documentation package.
- Replaced by: `docs/v10/06_V10_VIEWER_AND_UI_CONTRACT.md`, `docs/v10/19_V10_FRONTEND_SURFACE_CONTRACT.md`, and `docs/v10/16_V10_CONTEXT_CONTINUATION_PROTOCOL.md`
- Historical value: Yes. It records earlier UI scope assumptions and route expectations that informed V10.
