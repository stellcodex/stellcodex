...
- Reason retired: This mixed-language pre-V10 master file bundled product, UI, and technology decisions into a superseded authority root.
- Replaced by: `docs/v10/02_V10_PRODUCT_SCOPE_AND_IDENTITY.md`, `docs/v10/06_V10_VIEWER_AND_UI_CONTRACT.md`, and `docs/v10/19_V10_FRONTEND_SURFACE_CONTRACT.md`
- Historical value: Yes. It preserves early scope, route, and viewer assumptions that were normalized into V10.
